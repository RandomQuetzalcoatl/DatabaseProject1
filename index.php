...
<body>
    ...
    <div class="container">
        <form method="post" action="index.php">
            <button class="btn btn-primary" type="submit" name="viewMovies">View All Movies</button>
        </form>
    </div>
    ...
    <div class="container">
        <form method="post" action="index.php">
            <button class="btn btn-primary" type="submit" name="viewActors">View All Actors</button>
        </form>
    </div>
    ...
    if(isset($_POST['viewMovies'])) {
        // Handle view all movies action here
        // You need to write the SQL query and fetch/display data accordingly
        // Example:
    ...
    if(isset($_POST['viewActors'])) {
        // Handle view all actors action here
        // You need to write the SQL query and fetch/display data accordingly
        // Example:
        // $stmt = $conn->prepare("SELECT * FROM People WHERE nationality='Actor'");
        // Execute the query and display the data
    }
    ?>
</body>
